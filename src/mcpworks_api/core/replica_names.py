...
VERBS = [
    ...
    "clear", "clever", "cool", "crisp", "daring",
    "eager", "even", "fair", "fast", "fierce",
    "firm", "fleet", "fluid", "frank", "fresh",
    "glad", "grand", "great", "keen", "kind",
    "lively", "lucid", "merry", "mighty", "noble",
    "plain", "prime", "proud", "pure", "quick",
    "quiet", "rapid", "ready", "sharp", "sleek",
    "smart", "smooth", "snappy", "solid", "steady",
    "stout", "strong", "sturdy", "super", "swift",
]

ANIMALS = [
    "ant", "badger", "bear", "bison", "cobra",
    "condor", "crane", "crow", "deer", "dolphin",
    "dove", "duck", "eagle", "elk", "falcon",
    "finch", "fox", "frog", "goat", "goose",
    "gull", "hawk", "heron", "horse", "ibis",
    "jay", "kite", "lark", "lion", "lynx",
    "marten", "mink", "moose", "newt", "otter",
    "owl", "panda", "parrot", "pike", "puma",
    "quail", "ram", "raven", "robin", "salmon",
    "seal", "shrike", "snake", "squid", "stork",
    "swan", "tern", "tiger", "trout", "viper",
