...
<style>
  body { font-family: system-ui, -apple-system, sans-serif; max-width: 760px; margin: 2rem auto; padding: 0 1rem; color: #e4e4e7; background: #18181b; line-height: 1.6; }
  ...
  pre { background: #27272a; padding: 1rem; border-radius: 8px; overflow-x: auto; border: 1px solid #3f3f46; }
  pre code { background: none; padding: 0; }
  a { color: #60a5fa; }
  .step { background: #27272a; border-left: 3px solid #3b82f6; padding: 1rem 1.5rem; margin: 1rem 0; border-radius: 0 8px 8px 0; }
  .step-num { color: #3b82f6; font-weight: bold; font-size: 1.1em; }
  .time { color: #a1a1aa; font-size: 0.85em; }
  .tip { background: #1e3a5f; border: 1px solid #2563eb; padding: 1rem; border-radius: 8px; margin: 1rem 0; }
</style>
</head>
<body>
...
<p style="margin-top: 3rem; color: #71717a; font-size: 0.85em;">
