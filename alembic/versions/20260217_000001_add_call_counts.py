...
down_revision: str | None = "20260216_000002"
...
def upgrade() -> None:
    op.add_column(
        "namespaces", sa.Column("call_count", sa.Integer(), nullable=False, server_default="0")
    )
    op.add_column(
        "namespace_services",
    ...
    op.add_column(
        "functions", sa.Column("call_count", sa.Integer(), nullable=False, server_default="0")
    )
